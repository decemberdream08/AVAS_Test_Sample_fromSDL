                                                       ...
                                                       cy_stc_sd_host_context_t *context)
{
    ...
    cy_en_sd_host_bus_speed_mode_t speedMode = context->busSpeed;
    uint32_t retry;
                    ...
                    */
                    ...
                    { 
                        ...
                        if (CY_SD_HOST_SUCCESS == ret)
                        {
                            ...
                            (void)Cy_SD_Host_SdCardChangeClock(base, context->busClock);
        ...
        else if (CY_SD_HOST_EMMC == context->cardType)
        {
            switch (width)
            {
                ...
                case CY_SD_HOST_BUS_WIDTH_1_BIT:
                    ...
                    break;
                case CY_SD_HOST_BUS_WIDTH_4_BIT:
                    if((context->busSpeed == CY_SD_HOST_BUS_SPEED_EMMC_HIGHSPEED_SDR) || (context->busSpeed == CY_SD_HOST_BUS_SPEED_EMMC_LEGACY))
                    {
                        cmdArgument = (CY_SD_HOST_EMMC_ACCESS_WRITE_BYTE << CY_SD_HOST_EMMC_CMD6_ACCESS_OFFSET) |
                                      (CY_SD_HOST_EMMC_BUS_WIDTH_ADDR << CY_SD_HOST_EMMC_CMD6_IDX_OFFSET) |
                    ...
                    else if(context->busSpeed == CY_SD_HOST_BUS_SPEED_DDR50)
                    {
                        cmdArgument = (CY_SD_HOST_EMMC_ACCESS_WRITE_BYTE << CY_SD_HOST_EMMC_CMD6_ACCESS_OFFSET) |
                                      (CY_SD_HOST_EMMC_BUS_WIDTH_ADDR << CY_SD_HOST_EMMC_CMD6_IDX_OFFSET) |
                                      (0x5UL << CY_SD_HOST_EMMC_CMD6_VALUE_OFFSET) |
                                      (0x0UL << CY_SD_HOST_EMMC_CMD6_CMD_SET_OFFSET);
                    }
                    break;
                case CY_SD_HOST_BUS_WIDTH_8_BIT:
                    if(context->busSpeed == CY_SD_HOST_BUS_SPEED_EMMC_HIGHSPEED_SDR)
                    {
                        cmdArgument = (CY_SD_HOST_EMMC_ACCESS_WRITE_BYTE << CY_SD_HOST_EMMC_CMD6_ACCESS_OFFSET) |
                                      (CY_SD_HOST_EMMC_BUS_WIDTH_ADDR << CY_SD_HOST_EMMC_CMD6_IDX_OFFSET) |
                    ...
                    else if(context->busSpeed == CY_SD_HOST_BUS_SPEED_DDR50)
                    {
                        cmdArgument = (CY_SD_HOST_EMMC_ACCESS_WRITE_BYTE << CY_SD_HOST_EMMC_CMD6_ACCESS_OFFSET) |
                                      (CY_SD_HOST_EMMC_BUS_WIDTH_ADDR << CY_SD_HOST_EMMC_CMD6_IDX_OFFSET) |
				      (0x6UL << CY_SD_HOST_EMMC_CMD6_VALUE_OFFSET) |
                                      (0x0UL << CY_SD_HOST_EMMC_CMD6_CMD_SET_OFFSET);
                    }
                    break;
                default:
...
cy_en_sd_host_status_t Cy_SD_Host_Init(stc_SDHC_t *base,
                      ...
                      cy_stc_sd_host_context_t *context)
{
    uint8_t     clkOutDelay = CY_SD_HOST_CLK_OUT_DLY_DEFAULT;
    uint8_t     clkInDelay = CY_SD_HOST_CLK_IN_DLY_DEFAULT;
    cy_en_sd_host_status_t ret = CY_SD_HOST_SUCCESS;
    ...
    if ((NULL != base) && (NULL != config) && (NULL != context))
    {
        ...
        switch(context->busSpeed)
        {
            ...
            case CY_SD_HOST_BUS_SPEED_DEFAULT:
                clkOutDelay = CY_SD_HOST_CLK_OUT_DLY_DEFAULT;
                clkInDelay = CY_SD_HOST_CLK_IN_DLY_DEFAULT; 
                break;
            /* High Speed mode: 3.3V signaling at 50 MHz SDClk. */
            case CY_SD_HOST_BUS_SPEED_HIGHSPEED:
                clkOutDelay = CY_SD_HOST_CLK_OUT_DLY_SDR25_SDR50_EMMC_SDR;
                clkInDelay = CY_SD_HOST_CLK_IN_DLY_SDHS_EMMC_SDR; 
                break;
            ...
            case CY_SD_HOST_BUS_SPEED_SDR12_5:
                ...
                clkInDelay = CY_SD_HOST_CLK_IN_DLY_DEFAULT; 
                break;
            /**< SD25: UHS-I (1.8V signaling) at 50 MHz SDClk (25 MB/sec). */
            case CY_SD_HOST_BUS_SPEED_SDR25:
                clkOutDelay = CY_SD_HOST_CLK_OUT_DLY_SDR25_SDR50_EMMC_SDR;
                clkInDelay = CY_SD_HOST_CLK_IN_DLY_SDR25_SDR50; 
                break;
            /**< SD50: UHS-I (1.8V signaling) at 100 MHz SDClk (50 MB/sec). */
            ...
            case CY_SD_HOST_BUS_SPEED_DDR50:
                clkOutDelay = CY_SD_HOST_CLK_OUT_DLY_SDDDR50_EMMC_DDR;
                clkInDelay = CY_SD_HOST_CLK_IN_DLY_SDDDR50_EMMC_DDR; 
                break;
        }
        ...
        base->CORE.unGP_OUT_R.u32Register = _VAL2FLD(SDHC_CORE_GP_OUT_R_IO_VOLT_SEL_OE, 1u) | /* The IO voltage selection signal. */
                              ...
                              _VAL2FLD(SDHC_CORE_GP_OUT_R_CARD_CLOCK_OUT_DLY, clkOutDelay) | /* Select the clock out delay */
                              _VAL2FLD(SDHC_CORE_GP_OUT_R_CARD_CLOCK_IN_DLY, clkInDelay); /* Select the clock in delay */
    ...
    if (NULL != base)
    {
        ...
        switch (speedMode)
        {
            ...
            case CY_SD_HOST_BUS_SPEED_SDR50:
                ...
                break;
          case CY_SD_HOST_BUS_SPEED_DDR50:
              ultraHighSpeed = CY_SD_HOST_DDR50_SPEED;
              break;
            ...
            (CY_SD_HOST_COMBO == context->cardType))
        {
            ...
            switch (speedMode)
            {
                ...
                case CY_SD_HOST_BUS_SPEED_SDR50:
                    ...
                    break;
                case CY_SD_HOST_BUS_SPEED_EMMC_LEGACY:
                    highSpeedValue = 0; /* Max clock = 25 MHz */
                    break;
                case CY_SD_HOST_BUS_SPEED_EMMC_HIGHSPEED_SDR:
                    highSpeedValue = 0u;
                    break;
                case CY_SD_HOST_BUS_SPEED_DDR50:
                    if(CY_SD_HOST_EMMC == context->cardType)
                    {
                        highSpeedValue = 1u; /* Max clock = 50 MHz + DDR */
                    }
                    else
                    {
