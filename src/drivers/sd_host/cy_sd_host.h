...
#define CY_SD_HOST_CLK_12M                  (12UL * 1000UL * 1000UL) /* 12 MHz. */
#define CY_SD_HOST_CLK_20M                  (20UL * 1000UL * 1000UL) /* 20 MHz. */
#define CY_SD_HOST_CLK_25M                  (25UL * 1000UL * 1000UL) /* 25 MHz. */
...
/** Delay for card clock output */
typedef enum 
{
    CY_SD_HOST_CLK_OUT_DLY_DEFAULT              = 0U,  /**< SD Default Speed, SD High Speed, SD SDR12, eMMC Legacy */
    CY_SD_HOST_CLK_OUT_DLY_SDR25_SDR50_EMMC_SDR = 1U,  /**< SD SDR25, SD SDR50, eMMC High Speed SDR */
    CY_SD_HOST_CLK_OUT_DLY_SDDDR50_EMMC_DDR     = 3U,  /**< SD DDR50, eMMC DDR */
} cy_en_sd_host_card_clk_out_delay_type_t;

/** Delay for card clock input */
typedef enum 
{
    CY_SD_HOST_CLK_IN_DLY_DEFAULT               = 0U,  /**< SD Default Speed, SD SDR12, eMMC Legacy */
    CY_SD_HOST_CLK_IN_DLY_SDR25_SDR50           = 1U,  /**< SD SDR25, SD SDR50 */
    CY_SD_HOST_CLK_IN_DLY_SDHS_EMMC_SDR         = 2U,  /**< SD High Speed, eMMC High Speed SDR */
    CY_SD_HOST_CLK_IN_DLY_SDDDR50_EMMC_DDR      = 3U,  /**< SD DDR50, eMMC DDR */
} cy_en_sd_host_card_clk_in_delay_type_t;
...
{   
    ...
    cy_en_sd_host_bus_speed_mode_t  busSpeed;     /**< refer cy_en_sd_host_bus_speed_mode_t */
    uint32_t                        busClock;     /**< refer SD output clock */
