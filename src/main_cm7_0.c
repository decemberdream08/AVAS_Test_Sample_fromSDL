...
{                                                  
    ...
    .hsiom = 0, //mskim250826 USER_LED_PIN_MUX,                           
    .intEdge = 0,                                  
    .intMask = 0,                                  
    .vtrip = 0,                                    
    .slewRate = 0,                                 
...
int main(void)
{
    ...
    //mskim250826 Cy_GPIO_Pin_Init(USER_LED_PORT, USER_LED_PIN, &user_led_port_pin_cfg);
    ...
    for(;;)
    {
        ...
        //mskim250826 Cy_GPIO_Inv(USER_LED_PORT, USER_LED_PIN);
    }
}
